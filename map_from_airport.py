...
def main(
    ...
    png = f"h3_travel_times_map_from_{slug}{res_suffix}{galton_suffix}{labels_suffix}{proj_suffix}{grid_suffix}{title_suffix}{lat_suffix}{rivers_suffix}.png"
    ...
    plot_h3_map(
        ...
        title=title, lat_limits=lat_limits, rivers=rivers,
    )
